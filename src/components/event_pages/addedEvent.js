...
var userData = localStorage.getItem('userData' + userId) ? JSON.parse(localStorage.getItem('userData' + userId)) : {};
...
function AddedEvent() {
    ...
    if (userData && userData['event' + eventID]) {
        ...
        if (userData['event' + eventID]['placeProvider']) {
            allTabCloseObj.placeProvider = userData['event' + eventID]['placeProvider']
        }

        if (userData['event' + eventID]['photosAndVideos']) {
            allTabCloseObj.photosAndVideos = userData['event' + eventID]['photosAndVideos']
        }
        ...
        (async () => {
            ...
            try {
                ...
                if (response && response.data && response.data.data && response.data.data && response.data.data.length && response.data.data[0]) {
                    ...
                    if (tmpEventData && tmpEventData.event && tmpEventData.event.length && (tmpEventData.event[0].for_who_Id || tmpEventData.event[0].for_who)) {
            ...
            try {
                const response = await axios.get(`${API_URL}/add_place_event`, { headers: { "Content-Type": "application/json", Authorization: token } });
            ...
            try {
                const response = await axios.get(`${API_URL}/add_service_event`, { headers: { "Content-Type": "application/json", Authorization: token } });
            ...
            try {
                ...
                const response = await axios.get(`${API_URL}/event_forwho${forWhoParam}`, { headers: { "Content-Type": "application/json", Authorization: token } });
            ...
            let localStoreEvtData = localStorage.getItem('event' + eventID) ? JSON.parse(localStorage.getItem('event' + eventID)) : {};


            let tmpEventStateObj = {};

            if (tmpEventData && tmpEventData.display_name) { tmpEventStateObj.display_name = tmpEventData.display_name }
            if (tmpEventData && tmpEventData.eventId) { tmpEventStateObj.eventId = tmpEventData.eventId }
            ...
            if (tmpForWhoList.length) {
                ...
                if (tmpEventData && tmpEventData.event && tmpEventData.event[0] && tmpEventData.event[0] && tmpEventData.event[0]['for_who_Id']) {
                    tmpEventStateObj.forWhoTab.selectedForWhoID = tmpEventData.event[0]['for_who_Id']
                }
            ...
            if (tmpPlacesList.length) {
                ...
                if (tmpEventData && tmpEventData.event && tmpEventData.event[0] && tmpEventData.event[0] && tmpEventData.event[0]['place_Id']) {
                    tmpEventStateObj.placeProviderTab.selectedPlaceID = tmpEventData.event[0]['place_Id']
                    tmpEventStateObj.placeProviderTab.place_description = tmpEventData.event[0]['place_description']
                }
                ...
                if (localStoreEvtData.placeProviderTab) {
                    tmpEventStateObj.placeProviderTab = localStoreEvtData.placeProviderTab;
                }
            }


            tmpEventStateObj.photosAndVideosTab = { isOpen: false, isUpdated: false }
            if (tmpEventData && tmpEventData.image && tmpEventData.image.length) { tmpEventStateObj.photosAndVideosTab.imagesList = tmpEventData.image }
            if (tmpEventData && tmpEventData.image && tmpEventData.video.length) { tmpEventStateObj.photosAndVideosTab.videosList = tmpEventData.video }
            if (tmpEventData.image && tmpEventData.image.length && tmpEventData.image && tmpEventData.video.length) {
            ...
            if (tmpEventData && tmpEventData.event && tmpEventData.event[0] && tmpEventData.event[0].IncludingFacilities) {
            ...
            if(tmpEventData && tmpEventData.event && tmpEventData.event[0] && tmpEventData.event[0].service && tmpEventData.event[0].service.length){
                tmpEventStateObj.priceOfLocationTab.selectedServicesList = tmpEventData.event[0].service.map(i => i.s_id);
            }

            if (localStoreEvtData.priceOfLocationTab) {
                tmpEventStateObj.priceOfLocationTab = localStoreEvtData.priceOfLocationTab;
            }



            tmpEventStateObj.personParkingTab = { isOpen: false, isUpdated: false }
            if (tmpEventData && tmpEventData.event && tmpEventData.event[0] && tmpEventData.event[0].parking_capacity) {
                tmpEventStateObj.personParkingTab.parking_capacity = tmpEventData.event[0].parking_capacity;
            }
            if (tmpEventData && tmpEventData.event && tmpEventData.event[0] && tmpEventData.event[0].person_capacity) {
                tmpEventStateObj.personParkingTab.person_capacity = tmpEventData.event[0].person_capacity;
            }
            if (tmpEventData && tmpEventData.event && tmpEventData.event[0] && tmpEventData.event[0].let) {
                tmpEventStateObj.personParkingTab.let = tmpEventData.event[0].let;
            }
            if (tmpEventData && tmpEventData.event && tmpEventData.event[0] && tmpEventData.event[0].long) {
                tmpEventStateObj.personParkingTab.long = tmpEventData.event[0].long;
            }

            if (tmpEventData && tmpEventData.event && tmpEventData.event[0] && tmpEventData.event[0].address) {
                tmpEventStateObj.personParkingTab.address = tmpEventData.event[0].address;
            }
            ...
            if (tmpEventData && tmpEventData.event && tmpEventData.event[0]) {
                ...
                if (tmpEventData.event[0].t_and_c) { tmpEventStateObj.otherTab.t_and_c = tmpEventData.event[0].t_and_c }

                if (tmpEventData.event[0].facebook) { tmpEventStateObj.otherTab.facebook = tmpEventData.event[0].facebook }
                if (tmpEventData.event[0].youtube) { tmpEventStateObj.otherTab.youtube = tmpEventData.event[0].youtube }
                if (tmpEventData.event[0].twitter) { tmpEventStateObj.otherTab.twitter = tmpEventData.event[0].twitter }
                if (tmpEventData.event[0].pinterest) { tmpEventStateObj.otherTab.pinterest = tmpEventData.event[0].pinterest }
                if (tmpEventData.event[0].instagram) { tmpEventStateObj.otherTab.instagram = tmpEventData.event[0].instagram }
                if (tmpEventData.event[0].vimeo) { tmpEventStateObj.otherTab.vimeo = tmpEventData.event[0].vimeo }
    ...
    const handleNext = () => {
        ...
        if (tmpStateData.addNewTab.isOpen) {
            ...
            if (tmpStateData.placeProviderTab && tmpStateData.placeProviderTab.selectedPlaceID) {
            ...
            if (tmpStateData.personParkingTab && tmpStateData.personParkingTab.parking_capacity && tmpStateData.personParkingTab.person_capacity && tmpStateData.personParkingTab.address) {
        ...
        (async () => {
            try {
                ...
                if (response && response.data && response.data.data && response.data.data && response.data.data.length && response.data.data[0]) {
                    ...
                    let tmpStateData = { ...allEventData }
                    if (response.data.data[0] && response.data.data[0]['image'] && response.data.data[0]['image'][0]) {
                        tmpStateData.photosAndVideosTab.imagesList = response.data.data[0]['image'];
                    }
                    if (response.data.data[0] && response.data.data[0]['video'] && response.data.data[0]['video'][0]) {
                        tmpStateData.photosAndVideosTab.videosList = response.data.data[0]['video'];
                    }
    ...
    const videoUploaded = async (e) => {
        ...
        try {
            ...
            for (let i = 0; i < e.target.files.length; i++) formData.append("video", e.target.files[i]);
            formData.append("event", eventID);
    ...
    const saveCheckedService = (e) => {
        ...
        if (tmpStateData.priceOfLocationTab && tmpStateData.priceOfLocationTab.selectedServicesList) {
            let tmpServiceList = tmpStateData.priceOfLocationTab.selectedServicesList;
            if (tmpServiceList.includes(item)) {
                tmpServiceList = tmpServiceList.filter(function (e) { return e !== item })
                tmpStateData.priceOfLocationTab.selectedServicesList = tmpServiceList;
            } else {
                tmpServiceList.push(item)
            }
        } else {
            tmpStateData.priceOfLocationTab.selectedServicesList = [parseInt(e.target.value)]
        }
        ...
        if (!tncBox.current.checked) {
            ...
            (async () => {
                try {
                    ...
                    let forWhoString = "";
                    let selectedForWhoTmpData = allEventData.forWhoTab.forWhoList.filter((item) => { return parseInt(item.Id) === parseInt(allEventData.forWhoTab.selectedForWhoID) });
                    if (selectedForWhoTmpData.length) { forWhoString = selectedForWhoTmpData[0].plan_name || "" }

                    let placeName = "";
                    let placePrice = 0;
                    let selectedPlaceTmpData = allEventData.placeProviderTab.placesList.filter((item) => { return parseInt(item.Id) === parseInt(allEventData.placeProviderTab.selectedPlaceID) });
                    ...
                    //let serviceName = "";
                    let servicePrice = 0;
                    let serviceIDAry = allEventData.priceOfLocationTab.selectedServicesList;
                    ...
                    let postData = {
                        ...
                        IncludingFacilities: allEventData.priceOfLocationTab.IncludingFacilities ? true : false,
                        service_Id: serviceIDAry,
                        service_name: servicePrice,
                        service_price: servicePrice,
                        person_capacity: allEventData.personParkingTab.person_capacity || 0,
                        parking_capacity: allEventData.personParkingTab.parking_capacity || 0,
                    ...
                    const response = await axios[`${isPutRequest ? 'put' : 'post'}`](`${API_URL}/create_event`, postData, { headers: { "Content-Type": "application/json", Authorization: token } });
        ...
        <main>
            <div className="continent-wrapper">
                    ...
                    <div className="row">
                        <div className="col-12 col-md-12 col-lg-12 evant-titel event-add">
                            ...
                            <div className="e-btn">
                                {(allEventData.placeProviderTab?.isOpen) &&
                                    <button onClick={() => set_isAddPlacesModalOpen(true)} className="new-btn-creat">
                                        <i className="icon-plus" aria-hidden="true"></i>Add Place
                                    </button>
                                }

                                {(allEventData.priceOfLocationTab?.isOpen) &&
                                    <button onClick={() => set_isAddServicesModalOpen(true)} className="new-btn-creat">
                                ...
                                <Modal title="Add Listing" onClose={() => set_isAddPlacesModalOpen(false)} show={isAddPlacesModalOpen}>
                                    <AddPlace set_isAddPlacesModalOpen={set_isAddPlacesModalOpen} />
                                </Modal>

                                <Modal title="Add Service" onClose={() => set_isAddServicesModalOpen(false)} show={isAddServicesModalOpen}>
                                    <AddService set_isAddServicesModalOpen={set_isAddServicesModalOpen} />
                                </Modal>
                        ...
                        <div className="process-wrapper">
                            <ul>
                                ...
                                <li className={`process-stap ${(allEventData && allEventData.addNewTab && (isPutRequest || allEventData.addNewTab.isUpdated || allEventData.addNewTab.isOpen)) ? ' active' : ''}`} onClick={() => handleDirectTabClick('addNewTab')}>
                                    <input type="checkbox" id="cb1" hidden className="cb-btn" /><span>01</span><br />
                                    <label className="selact-btn" for="cb1">Add New</label>
                                </li>
                                <li className={`process-stap ${(allEventData && allEventData.forWhoTab && (isPutRequest || allEventData.forWhoTab.isUpdated || allEventData.forWhoTab.isOpen)) ? ' active' : ''}`} onClick={() => handleDirectTabClick('forWhoTab')}>
                                    <input type="checkbox" id="cb2" hidden className="cb-btn" /><span>02</span><br />
                                    <label className="selact-btn" for="cb2">For all or Couple</label>
                                </li>
                                <li className={`process-stap ${(allEventData && allEventData.placeProviderTab && (isPutRequest || allEventData.placeProviderTab.isUpdated || allEventData.placeProviderTab.isOpen)) ? ' active' : ''}`} onClick={() => handleDirectTabClick('placeProviderTab')}>
                                    <input type="checkbox" id="cb3" hidden className="cb-btn" /><span>03</span><br />
                                    <label className="selact-btn" for="cb3">Place Provider</label>
                                </li>
                                <li className={`process-stap ${(allEventData && allEventData.photosAndVideosTab && (isPutRequest || allEventData.photosAndVideosTab.isUpdated || allEventData.photosAndVideosTab.isOpen)) ? ' active' : ''}`} onClick={() => handleDirectTabClick('photosAndVideosTab')}>
                                    <input type="checkbox" id="cb4" hidden className="cb-btn" /><span>04</span><br />
                                    <label className="selact-btn" for="cb4">Photos & videos</label>
                                </li>
                                <li className={`process-stap ${(allEventData && allEventData.priceOfLocationTab && (isPutRequest || allEventData.priceOfLocationTab.isUpdated || allEventData.priceOfLocationTab.isOpen)) ? ' active' : ''}`} onClick={() => handleDirectTabClick('priceOfLocationTab')}>
                                    <input type="checkbox" id="cb5" hidden className="cb-btn" /><span>05</span><br />
                                    <label className="selact-btn" for="cb5">Price of Location</label>
                                </li>
                                <li className={`process-stap ${(allEventData && allEventData.personParkingTab && (isPutRequest || allEventData.personParkingTab.isUpdated || allEventData.personParkingTab.isOpen)) ? ' active' : ''}`} onClick={() => handleDirectTabClick('personParkingTab')}>
                                    <input type="checkbox" id="cb6" hidden className="cb-btn" /><span>06</span><br />
                                    <label className="selact-btn" for="cb6">Person / Parking</label>
                                </li>
                                <li className={`process-stap ${(allEventData && allEventData.otherTab && (isPutRequest || allEventData.otherTab.isUpdated || allEventData.otherTab.isOpen)) ? ' active' : ''}`} onClick={() => handleDirectTabClick('otherTab')}>
                                    <input type="checkbox" id="cb7" hidden className="cb-btn" /><span>07</span><br />
                                    <label className="selact-btn" for="cb7">Other</label>
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <div className="col-12 col-md-12 edit-event">
                                        <div className="edit-titel">
                                            ...
                                            <div className="edit-btn">
                                                <button type="button" class="btn">Delete<i className="icon-Delete"></i></button>&nbsp;
                                                <button type="button" class="btn" onClick={() => editEvent(parseInt(eventID))}>Edit<i className="icon-Edit"></i></button>
                                                <Modal title="My Modal" onClose={() => setShow(false)} show={show}>
                                                    <EditEvent fetchEventDataAgain={fetchEventDataAgain} setShow={setShow} eventID={parseInt(eventID)} categoryId={parseInt(eventObj.categoryId)} display_name={eventObj.display_name} />
                                                </Modal>
                                            </div>
                                        </div>
                                        ...
                                        <div className="loction-r-holder">
                                            <div className="s-product">
                                                <div className="material-switch center-btn">
                                                    ...
                                                    <label for="someSwitchOptionDefault2" className="label-default1"></label><span>For Couple</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="d-t">
                                            {(allEventData.forWhoTab && allEventData.forWhoTab.forWhoList && allEventData.forWhoTab.forWhoList.length) && allEventData.forWhoTab.forWhoList.map((eventForWhoObj) => (
                                                <div className="radio-btn" key={eventForWhoObj.Id}>
                                                    <input
                                                        checked={(allEventData.forWhoTab && allEventData.forWhoTab.selectedForWhoID && parseInt(allEventData.forWhoTab.selectedForWhoID) === parseInt(eventForWhoObj.Id)) ? true : false}
                                                        onChange={(e) => setForWhoValue(parseInt(e.target.value))}
                                                        value={`${eventForWhoObj.Id}`}
                                                        id={`place${eventForWhoObj.Id}`}
                                                        type="radio"
                                                        name="placeProvider"
                                                    />
                                                    <label for={`place${eventForWhoObj.Id}`}>{eventForWhoObj.plan_name}</label>
                                                </div>
                                            ))}
                                        </div>
                                    </div>
                        ...
                        {
                            (allEventData.placeProviderTab && allEventData.placeProviderTab.isOpen) &&
                            <div className="r-btn-group place-povider">
                                        ...
                                        <div className="radio-btn" key={item.Id}>
                                            <label>
                                                <span>
                                                    <input
                                                        type="radio"
                                                        checked={(allEventData.placeProviderTab && allEventData.placeProviderTab.selectedPlaceID && parseInt(allEventData.placeProviderTab.selectedPlaceID) === parseInt(item.Id))}
                                                        value={item.Id}
                                                        name="placeProvider"
                                                        onChange={(e) => setPlaceProvider(parseInt(e.target.value))}
                                                    />
                                                </span>
                                                {item.place_name}
                                ...
                                <div className="provider-textaria">
                                    ...
                                    <textarea
                                        ...
                                        value={(allEventData.placeProviderTab && allEventData.placeProviderTab.place_description) || ""}
                                    ></textarea>
                                </div>
                            </div>
                        }
                        ...
                        {
                            (allEventData.photosAndVideosTab && allEventData.photosAndVideosTab.isOpen) &&
                            <div className="photo-video-holder">
                                ...
                                <form method="post">
                                    <div className="p-v-main">
                                        ...
                                        <div className="poster-m">
                                            <div className="images-selctor ">
                                                <input multiple type="file" className="file-input" name="image[]" accept="image/*" onChange={(e) => imageUploaded(e)} />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="p-v-main video-uploder">
                                        ...
                                        <div className="poster-m">
                                            <div className="images-selctor ">
                                                <input multiple type="file" className="file-input" name="video[]" accept="video/*" onChange={(e) => videoUploaded(e)} />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="ph-main">
                                        ...
                                        <div className="img-holder">
                                            ...
                                            {allEventData.photosAndVideosTab && allEventData.photosAndVideosTab && allEventData.photosAndVideosTab.videosList && allEventData.photosAndVideosTab.videosList.map((videoObj) => {
                        ...
                        {
                            (allEventData.priceOfLocationTab && allEventData.priceOfLocationTab.isOpen) &&
                                ...
                                <div className="Including-radio">
                                    <div className="r-btn-group place-povider">
                                        <div className="radio-btn">
                                            ...
                                            <input
                                                defaultChecked={(allEventData.priceOfLocationTab && allEventData.priceOfLocationTab.IncludingFacilities) ? true : false}
                                                type="checkbox"
                                                id="includingFacility"
                                                onChange={() => { set_includingFacility((allEventData.priceOfLocationTab && allEventData.priceOfLocationTab.IncludingFacilities) ? false : true) }}
                                            />
                                            <label for="includingFacility">Including Facilities in this price</label>
                                        </div>
                                                ...
                                                {servicesAry.map((item) => (
                                                    <div className="excluding-item" key={item.Id}>
                                                        <div className="excluding-i-titel">
                                                            ...
                                                            <span>{item.service_price}/{`${parseInt(item.service_price_type) === 1 ? "PP" : "PE"}`}</span>
                                                            <div className="s-product">
                                                                <div className="material-switch center-btn">
                                                                    <input
                                                                        id={`service${item.Id}`}
                                                                        ...
                                                                        value={item.Id}
                                                                        data-toggle-switch
                                                                        defaultChecked={(allEventData.priceOfLocationTab && allEventData.priceOfLocationTab.selectedServicesList && allEventData.priceOfLocationTab.selectedServicesList.includes(item.Id)) ? true : false}
                                                                    />
                                                                    <label for={`service${item.Id}`} className="label-default1"></label>
                                                                </div>
                                                            </div>
                                                        </div>
                        ...
                        {
                            (allEventData.personParkingTab && allEventData.personParkingTab.isOpen) &&
                            <div className="event-wrapper">
                                <div className="person-capacity-holder">
                                    <div className="shop-name">
                                        <span for="">Person Capacity</span>
                                        <input type="number" onChange={(e) => savePersonAndParkingData(parseInt(e.target.value), 'person_capacity')} value={(allEventData.personParkingTab && allEventData.personParkingTab && allEventData.personParkingTab.person_capacity) ? allEventData.personParkingTab.person_capacity : null} />
                                    </div>
                                    <div className="shop-name">
                                        <span for="">Parking Capacity</span>
                                        <input type="number" onChange={(e) => savePersonAndParkingData(parseInt(e.target.value), 'parking_capacity')} value={(allEventData.personParkingTab && allEventData.personParkingTab && allEventData.personParkingTab.parking_capacity) ? allEventData.personParkingTab.parking_capacity : null} />
                                    </div>
                                    <div className="event-add">
                                        <span>What’s the Location?</span>
                                        <textarea placeholder="Type here Address..." value={(allEventData.personParkingTab && allEventData.personParkingTab && allEventData.personParkingTab.address) ? allEventData.personParkingTab.address : null} onChange={(e) => savePersonAndParkingData(e.target.value, 'address')} cols="30" rows="5"></textarea>
                            ...
                            <div className="event-wrapper">
                                <div className="person-capacity-holder">
                                    ...
                                    <div className="textaditor">
                                        ...
                                        <textarea value={(allEventData.otherTab && allEventData.otherTab.t_and_c) ? allEventData.otherTab.t_and_c : null} onChange={(e) => saveOtherData(e.target.value, 't_and_c')} id='editor' placeholder="text type" contenteditable></textarea>
                                    </div>
                                        ...
                                        <div className="s-pletform">
                                            <div className="row mx-0 mt-1">
                                                <div className="col-md-6 col-12 pl-0 pr-2">
                                                    <label for="">
                                                        <div className="s-pleform-icon"><img src={fb} alt="" /></div>
                                                        <input type="text" placeholder="Enter URL" onChange={(e) => saveOtherData(e.target.value, 'facebook')} value={(allEventData.otherTab && allEventData.otherTab.facebook) ? allEventData.otherTab.facebook : null} />
                                                    </label>
                                                </div>
                                                <div className="col-md-6 col-12 px-0">
                                                    <label for="">
                                                        <div className="s-pleform-icon"><img src={youtub} alt="" /></div>
                                                        <input type="text" placeholder="Enter URL" onChange={(e) => saveOtherData(e.target.value, 'youtube')} value={(allEventData.otherTab && allEventData.otherTab.youtube) ? allEventData.otherTab.youtube : null} />
                                                    </label>
                                                </div>
                                                <div className="col-md-6 col-12 pl-0 mt-2 pr-2">
                                                    <label for="">
                                                        <div className="s-pleform-icon"><img src={twitter} alt="" /></div>
                                                        <input type="text" placeholder="Enter URL" onChange={(e) => saveOtherData(e.target.value, 'twitter')} value={(allEventData.otherTab && allEventData.otherTab.twitter) ? allEventData.otherTab.twitter : null} />
                                                    </label>
                                                </div>
                                                <div className="col-md-6 col-12 px-0 mt-2">
                                                    <label for="">
                                                        <div className="s-pleform-icon"><img src={printrest} alt="" /></div>
                                                        <input type="text" placeholder="Enter URL" onChange={(e) => saveOtherData(e.target.value, 'pinterest')} value={(allEventData.otherTab && allEventData.otherTab.pinterest) ? allEventData.otherTab.pinterest : null} />
                                                    </label>
                                                </div>
                                                <div className="col-md-6 col-12 pl-0 mt-2 pr-2">
                                                    <label for="">
                                                        <div className="s-pleform-icon"><img src={instagram} alt="" /></div>
                                                        <input type="text" placeholder="Enter URL" onChange={(e) => saveOtherData(e.target.value, 'instagram')} value={(allEventData.otherTab && allEventData.otherTab.instagram) ? allEventData.otherTab.instagram : null} />
                                                    </label>
                                                </div>
                                                <div className="col-md-6 col-12 px-0 mt-2">
                                                    <label for="">
                                                        <div className="s-pleform-icon"><img src={vimo} alt="" /></div>
                                                        <input type="text" placeholder="Enter URL" onChange={(e) => saveOtherData(e.target.value, 'vimeo')} value={(allEventData.otherTab && allEventData.otherTab.vimeo) ? allEventData.otherTab.vimeo : null} />
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="form-check check-input-s">
                                            <input type="checkbox" ref={tncBox} className="form-check-input" id="exampleCheck1" />
                ...
                <div className="next-prw-holder ">
                    <button className="prew" onClick={handlePrevious}><i className="icon-Back"></i>Back</button>
                    <button className="next" onClick={handleNext}>Next<i className="icon-Next"></i></button>
                </div>
            </div>
        </main>
    );
